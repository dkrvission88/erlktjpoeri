...
const{createRegistration,updateRegistration,rejectedData,approvedData,regionOneData,region2Data,pendingList,getSingleData,viewAllRegistrations,regionTransfer,regionOneGPA,getAllRegion2GPA}=require("../controllers/registrationController")
const{sendOtp,verifyOTP, subsOtp}=require("../controllers/weblimeServices")
...
// router.route("/regionTwoGPA-Data").get(getAllRegion2GPA)
