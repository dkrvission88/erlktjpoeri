...
// admin info
// export const getAdminInfo = async (data, headers) =>{
//     return await commonrequest("get", `${BACKEND_URL}/api/admin/get-admin-info-by-id`, data, headers);
// }
