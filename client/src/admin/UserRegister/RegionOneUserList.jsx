...
const RegionOneUserList = () => {
  ...
  const fetchApplications = async () => {
    try {
      ...
      console.log(response.data.RegionOneData)
      setApplications(response.data.RegionOneData);
    } catch (error) {
        ...
        <div>
          <div className="box_header">
            <div style={{ padding: "5px 0px" }}>
              <i className="fa-regular fa-rectangle-list mx-3"></i>&nbsp; Total Region-1 Users: <b>{applications.length}</b>
            </div>
          </div>
          <div>
