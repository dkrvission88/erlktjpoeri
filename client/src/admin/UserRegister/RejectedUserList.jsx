...
const RejectedUserList = () => {
  ...
  const fetchApplications = async () => {
    try {
      ...
      console.log(response.data.RejectedData)
      setApplications(response.data.RejectedData);
    } catch (error) {
        ...
        <div>
          <div className="box_header">
            <div style={{ padding: "5px 0px" }}>
              <i className="fa-regular fa-rectangle-list mx-3"></i>&nbsp;  Total Rejected Users: <b>{applications.length}</b>
            </div>
          </div>
          <div>
