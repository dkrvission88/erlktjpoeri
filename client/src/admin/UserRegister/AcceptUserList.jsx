        ...
        <div>
          <div className="box_header">
            <div style={{ padding: "5px 0px" }}>
              <i className="fa-regular fa-rectangle-list mx-3"></i>&nbsp;  Total Accepted Users: <b>{applications.length}</b>
            </div>
          </div>
          <div>
                ...
                <tbody>
                  {filteredUsers.length > 0 ? (
                    filteredUsers.map((app, index) => (
                      <tr key={app.application_no}  style={{ backgroundColor: "green", color: "white" }}>
                        <td>{index + 1}</td>
